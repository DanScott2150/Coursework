...
Person.prototype.addToFamily = function(newPerson){
  if(newPerson instanceof Person){
    if(!this.family.includes(newPerson)){
...
***NOTE: Line 56, official solution instead uses this.family.indexOf(newPerson) === -1
          'includes()' is new per ES2016, previously you had to use indexOf === -1


// PART II

// 1 - Implement your own version of Array.prototype.map. The function should accept a
// callback and return a new array with the result of the callback for each value in the array.
