===== 1.26 =====
  - Node.js Course:
    ...
    Long section. Finished the first ~90 minutes covering Mongo. Set up on local environment which was
    really good to learn: my FishApp project uses Mongo, but I'm using c9.io to develop it so never had to
    actually set up mongo on my local computer.
    Mongo basics, set up collections & documents. Basic CRUD functions.
...
===== 11.20 =====
  - Wes Bos JavaScript30: Day 1 completed
